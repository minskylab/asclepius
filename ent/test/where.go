...
func HasClinical() predicate.Test {
	return predicate.Test(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ClinicalTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ClinicalTable, ClinicalColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasClinicalWith(preds ...predicate.ClinicalResults) predicate.Test {
	return predicate.Test(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ClinicalInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ClinicalTable, ClinicalColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasEpidemiologic() predicate.Test {
	return predicate.Test(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(EpidemiologicTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, EpidemiologicTable, EpidemiologicColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasEpidemiologicWith(preds ...predicate.EpidemiologicResults) predicate.Test {
	return predicate.Test(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(EpidemiologicInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, EpidemiologicTable, EpidemiologicColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
